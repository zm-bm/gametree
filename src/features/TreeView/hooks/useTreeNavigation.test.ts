...
import { getPanToNodeTransform, getZoomedTransform, useTreeNavigation } from './useTreeNavigation';
...
describe('useTreeNavigation', () => {
  ...
  it('starts zoom animation from the live transformRef value', () => {
    ...
    const expected = getZoomedTransform(transformRef.current, { width: 300, height: 200 }, 'in');
