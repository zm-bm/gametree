...
describe('TreeCanvas', () => {
  ...
  it('wires size hook dimensions into TreeDimensionsProvider and Zoom', () => {
    renderTreeViewWithContexts(<TreeCanvas />, {
    ...
    // TreeCanvas should provide its own dimensions/zoom values, overriding outer test providers.
